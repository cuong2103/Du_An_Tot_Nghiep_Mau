    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-teal-500 text-white p-12 flex-col justify-between">
            ...
            <div class="text-sm text-blue-200">
                &copy; <?php echo e(date('Y')); ?> CareBook. All rights reserved.
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-6" x-data="{ loading: false }" @submit="loading = true">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH F:\Du_An_Tot_Nghiep_Mau\resources\views/auth/login.blade.php ENDPATH**/ ?>