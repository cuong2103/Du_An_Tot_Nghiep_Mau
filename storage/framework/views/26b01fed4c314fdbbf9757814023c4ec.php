...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Quản lý Chuyên khoa']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Quản lý Chuyên khoa']); ?>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <input type="number" value="<?php echo e($specialty->display_order); ?>" min="0"
                                        onblur="updateOrder(<?php echo e($specialty->id); ?>, this.value)"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <a href="<?php echo e(route('admin.specialties.show', $specialty->id)); ?>" class="text-sm font-bold text-blue-600 hover:text-blue-800 transition-colors"><?php echo e($specialty->name); ?></a>
                                            <?php if($specialty->description): ?>
                                                <div class="text-xs text-gray-500 mt-1 line-clamp-1" title="<?php echo e($specialty->description); ?>"><?php echo e($specialty->description); ?></div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">
                                        <i class="fa-solid fa-user-doctor mr-1.5"></i> <?php echo e($specialty->doctors_count); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">
                                        <i class="fa-solid fa-door-open mr-1.5"></i> <?php echo e($specialty->rooms_count); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-3">
                                        <button @click="$dispatch('edit-specialty', { 
                                            id: <?php echo e($specialty->id); ?>, 
                                            name: '<?php echo e(addslashes($specialty->name)); ?>', 
                                            description: '<?php echo e(addslashes($specialty->description)); ?>', 
                                            display_order: <?php echo e($specialty->display_order); ?>, 
                                            is_active: <?php echo e($specialty->is_active ? 'true' : 'false'); ?> 
                                        })" class="text-blue-600 hover:text-blue-900 transition-colors" title="Sửa">
                                            <i class="fa-solid fa-pen"></i>
                                        </button>
                                        
                                        <form action="<?php echo e(route('admin.specialties.toggle-active', $specialty->id)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <button type="submit" class="text-gray-500 hover:text-gray-800 transition-colors" title="<?php echo e($specialty->is_active ? 'Ẩn chuyên khoa' : 'Hiện chuyên khoa'); ?>">
                                                <i class="fa-solid <?php echo e($specialty->is_active ? 'fa-eye-slash' : 'fa-eye'); ?>"></i>
                                            </button>
                                        </form>

                                        <form action="<?php echo e(route('admin.specialties.destroy', $specialty->id)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
        ...
        <div class="w-full lg:w-1/3">
            <div x-data="{
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                    ...
                    <div class="p-6">
                        <form x-bind:action="mode === 'create' ? '<?php echo e(route('admin.specialties.store')); ?>' : '<?php echo e(url('admin/specialties')); ?>/' + form.id" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        function updateOrder(id, order) {
            fetch(`<?php echo e(url('admin/specialties')); ?>/${id}/order`, {
                method: 'PATCH',
                headers: {
...
<?php endif; ?>
<?php /**PATH F:\Du_An_Tot_Nghiep_Mau\resources\views/admin/specialties/index.blade.php ENDPATH**/ ?>