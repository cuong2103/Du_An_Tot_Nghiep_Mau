<x-layouts.admin title="Thêm lịch hẹn mới">
    ...
    <form action="{{ route('admin.appointments.store') }}" method="POST" 
          x-data="{ 
              weight: '{{ old('vital_weight_kg') }}', 
              height: '{{ old('vital_height_cm') }}',
              get bmi() {
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div>
                            ...
                            <select name="patient_profile_id" required class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none bg-white">
                                ...
                                @foreach($patients as $pat)
                                    <option value="{{ $pat->id }}" {{ old('patient_profile_id') == $pat->id ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" name="appointment_date" value="{{ old('appointment_date', today()->toDateString()) }}" required min="{{ today()->toDateString() }}" class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Giờ khám <span class="text-red-500">*</span></label>
                            <input type="time" name="appointment_time" value="{{ old('appointment_time') }}" required class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <select name="status" required class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none bg-white">
                                ...
                                <option value="checked_in" {{ old('status') === 'checked_in' ? 'selected' : '' }}>Đã tiếp nhận</option>
                                <option value="examining" {{ old('status') === 'examining' ? 'selected' : '' }}>Đang khám</option>
                        ...
                        <div>
                            ...
                            <select name="source" required class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none bg-white">
                                <option value="counter" {{ old('source', 'counter') === 'counter' ? 'selected' : '' }}>Quầy lễ tân</option>
                                <option value="web" {{ old('source') === 'web' ? 'selected' : '' }}>Website đặt trực tuyến</option>
                                <option value="chatbot" {{ old('source') === 'chatbot' ? 'selected' : '' }}>Hỗ trợ Chatbot</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="reason" rows="3" required placeholder="Nhập triệu chứng sơ bộ hoặc lý do khám..." class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">{{ old('reason') }}</textarea>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Ghi chú của lễ tân</label>
                        <textarea name="receptionist_note" rows="2" placeholder="Ghi chú thêm về yêu cầu đặc biệt của bệnh nhân..." class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">{{ old('receptionist_note') }}</textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="vital_pulse" value="{{ old('vital_pulse') }}" min="0" placeholder="VD: 80" class="block w-full py-2 pl-3 pr-12 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="vital_respiratory" value="{{ old('vital_respiratory') }}" min="0" placeholder="VD: 18" class="block w-full py-2 pl-3 pr-12 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="vital_systolic_bp" value="{{ old('vital_systolic_bp') }}" min="0" placeholder="VD: 120" class="block w-full py-2 pl-3 pr-12 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="vital_diastolic_bp" value="{{ old('vital_diastolic_bp') }}" min="0" placeholder="VD: 80" class="block w-full py-2 pl-3 pr-12 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">
                                    <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-xs text-gray-400 pointer-events-none">mmHg</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" step="0.1" name="vital_temperature" value="{{ old('vital_temperature') }}" min="0" placeholder="VD: 36.5" class="block w-full py-2 pl-3 pr-8 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" step="0.1" name="vital_spo2" value="{{ old('vital_spo2') }}" min="0" max="100" placeholder="VD: 98" class="block w-full py-2 pl-3 pr-8 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">
                        ...
                        <div>
                            ...
                            <textarea name="vital_note" rows="2" placeholder="Ghi chú thêm về mạch, huyết áp hoặc trạng thái đo..." class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none">{{ old('vital_note') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="measured_by" class="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm outline-none bg-white">
                                ...
                                @foreach($users as $usr)
                                    <option value="{{ $usr->id }}" {{ old('measured_by', Auth::id()) == $usr->id ? 'selected' : '' }}>
